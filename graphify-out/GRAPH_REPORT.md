...
## Corpus Check
- 107 files · ~24,287 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 654 nodes · 1141 edges · 42 communities (41 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9f672cdf`
...
Cohesion: 0.05
Nodes (53): analysis, first, profileResult, result, second, seedCluster, buildDescriptorClusters(), buildSeedCorpusProfiles() (+45 more)
...
Cohesion: 0.12
Nodes (26): inputs, score, buildDescriptorToFamilies(), buildSeedCanonicalSet(), buildSeedPairSet(), buildTaxonomyDescriptorSet(), findAliasCandidates(), intersects() (+18 more)

### Community 5 - "Volatility Calculation"
Cohesion: 0.13
Nodes (23): combineResults(), CompiledAliases, CompilerValidationError, CompilerValidationResult, findNullsDeep(), makeCompilerError(), isNonEmptyString(), isNonNegativeNumber() (+15 more)

### Community 6 - "Test Configuration"
Cohesion: 0.07
Nodes (22): AnalysisMaterial, candidates, __dirname, __filename, frequency, pair, taxonomySeed, withoutSeed (+14 more)
...
Cohesion: 0.14
Nodes (16): clampScore(), combineScores(), DEFAULT_SCORE_WEIGHTS, DIMENSION_KEYS, shouldKeepEdge(), AccordCompatibilityEvidence, DescriptorCluster, DescriptorClusterEvidence (+8 more)
...
Cohesion: 0.22
Nodes (10): AnalysisMaterial, computeCoOccurrence(), computeFrequencyAndCoOccurrence(), FrequencyAndCoOccurrence, toSortedDescriptorSet(), decodePairKey(), encodePairKey(), CoOccurrenceEdge (+2 more)
...
## Knowledge Gaps
- **262 isolated node(s):** `CompiledAliases`, `CompilerValidationError`, `result`, `data`, `dup` (+257 more)
...
- **Why does `normalizeDescriptor()` connect `Core Types` to `Utilities & Normalization`, `Engine Tests`, `Test Configuration`, `Community 19`, `Community 20`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `TaxonomySeed` connect `Utilities & Normalization` to `Weight Configuration`, `Engine Tests`, `Test Configuration`, `Community 18`, `Community 19`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `CorpusAnalysis` connect `Utilities & Normalization` to `Engine Tests`, `Community 14`, `Community 16`, `Community 18`, `Community 19`, `Community 20`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **What connects `CompiledAliases`, `CompilerValidationError`, `result` to the rest of the system?**
