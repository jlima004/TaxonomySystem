...
## Corpus Check
- 120 files · ~28,402 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 725 nodes · 1265 edges · 51 communities (50 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4ef0fbc6`
...
Cohesion: 0.08
Nodes (33): compileAliases(), CompileAliasesOptions, result, seed, CompileAllOptions, choosePlacement(), compileTaxonomy(), CompileTaxonomyOptions (+25 more)
...
Cohesion: 0.07
Nodes (30): countSubfamilies(), exists(), main(), NoiseConfig, printHelp(), printValidationErrors(), resolveOutputDir(), resolveReadablePath() (+22 more)
...
Cohesion: 0.19
Nodes (15): computeAccordCompatibility(), assertNonEmptyString(), clamp01(), isNonEmptyString(), isRecord(), makeSubfamilyPairKey(), validateAccordMapInput(), validateCuratedRelationsInput() (+7 more)
...
Cohesion: 0.23
Nodes (13): CorpusNoiseSuggestionOptions, looksLikeCorpusNoiseSuggestion(), scoreSemanticNoise(), SemanticNoiseOptions, suggestCorpusSemanticNoise(), toNormalizedSet(), buildSeedCorpusProfiles(), collectSeedDescriptors() (+5 more)

### Community 16 - "Community 16"
Cohesion: 0.22
Nodes (14): buildDescriptorToFamilies(), buildSeedCanonicalSet(), buildSeedPairSet(), buildTaxonomyDescriptorSet(), findAliasCandidates(), intersects(), isMultiToken(), isSubstringOnly() (+6 more)

### Community 17 - "Community 17"
Cohesion: 0.15
Nodes (14): clampScore(), combineScores(), DEFAULT_SCORE_WEIGHTS, DIMENSION_KEYS, shouldKeepEdge(), AccordCompatibilityEvidence, CorpusNoiseSuggestion, DescriptorClusterEvidence (+6 more)

### Community 18 - "Community 18"
Cohesion: 0.13
Nodes (12): AnalysisMaterial, candidates, __dirname, __filename, frequency, pair, taxonomySeed, withoutSeed (+4 more)
...
Cohesion: 0.2
Nodes (11): AliasCandidateOptions, AnalysisMaterial, AnalyzeCorpusOptions, AnalysisMaterial, computeCoOccurrence(), computeFrequencyAndCoOccurrence(), FrequencyAndCoOccurrence, toSortedDescriptorSet() (+3 more)
...
Cohesion: 0.2
Nodes (9): 🏗️ Arquitetura em Camadas, code:bash (# Instalar dependências (typescript, vitest)), 🚀 Como Funciona o Builder, 📂 Estrutura do Projeto, Executando o Projeto, 🎯 Objetivo (Core Value), Olfactory Taxonomy System, 🛠️ Regras e Convenções do Repositório (+1 more)
...
Cohesion: 0.53
Nodes (4): inputs, score, levenshteinDistance(), levenshteinSimilarity()
...
## Knowledge Gaps
- **283 isolated node(s):** `🎯 Objetivo (Core Value)`, `🏗️ Arquitetura em Camadas`, `📂 Estrutura do Projeto`, `code:bash (# Instalar dependências (typescript, vitest))`, `🛠️ Regras e Convenções do Repositório` (+278 more)
...
- **Why does `normalizeDescriptor()` connect `Core Types` to `Community 9`, `Community 15`, `Community 16`, `Community 18`, `Community 21`, `Community 23`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `TaxonomySeed` connect `Community 36` to `Utilities & Normalization`, `Weight Configuration`, `Engine Tests`, `Community 9`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 22`, `Community 24`, `Community 31`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `CorpusAnalysis` connect `Community 25` to `Utilities & Normalization`, `Engine Tests`, `Community 9`, `Community 13`, `Community 14`, `Community 15`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 31`?**
