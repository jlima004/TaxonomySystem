...
## Summary
- 971 nodes · 1955 edges · 57 communities (52 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5cbc637d`
...
Cohesion: 0.14
Nodes (23): clampScore(), DIMENSION_KEYS, DEFAULT_PLACEMENT_THRESHOLDS, normalizeFrequency(), scoreCandidatePlacement(), AccordCompatibilityEvidence, AccordCompatibilityScore, AliasEvidenceScore (+15 more)
...
Cohesion: 0.22
Nodes (20): buildSimilarityGraph(), BuildSimilarityGraphOptions, buildSubfamilyProfiles(), computeCooccurrenceSupport(), getDescriptorCooccurrence(), graphDimensions(), makeAliasReviewItem(), makeCorpusSupportMap() (+12 more)

### Community 17 - "Community 17"
Cohesion: 0.22
Nodes (17): accordMap, buildFixtureGraph(), curatedRelations, __dirname, edges, emitted, __filename, FixtureAliasCandidate (+9 more)
...
- **Why does `normalizeDescriptor()` connect `Tenacity Calculation` to `Engine Tests`, `Community 37`, `Community 7`, `Community 16`, `Community 25`, `Community 27`, `Community 28`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `TaxonomySeed` connect `Utilities & Normalization` to `Weight Configuration`, `Engine Tests`, `Volatility Calculation`, `Community 7`, `Community 10`, `Community 16`, `Community 17`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `CorpusAnalysis` connect `Utilities & Normalization` to `Weight Configuration`, `Engine Tests`, `Community 7`, `Community 10`, `Community 16`, `Community 17`, `Community 22`, `Community 25`?**
