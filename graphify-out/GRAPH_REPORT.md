# Graph Report - TaxonomySystem  (2026-05-20)
...
## Summary
- 632 nodes · 1099 edges · 45 communities (44 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a3f902be`
...
Cohesion: 0.12
Nodes (18): clampScore(), combineScores(), DEFAULT_SCORE_WEIGHTS, DIMENSION_KEYS, shouldKeepEdge(), AccordCompatibilityEvidence, AccordCompatibilityScore, CorpusNoiseSuggestion (+10 more)
...
- **Why does `normalizeDescriptor()` connect `Utilities & Normalization` to `Engine Tests`, `Community 12`, `Community 15`, `Community 16`, `Community 18`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `TaxonomySeed` connect `Core Types` to `Weight Configuration`, `Engine Tests`, `Community 12`, `Community 17`, `Community 18`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `CorpusAnalysis` connect `Community 16` to `Core Types`, `Community 12`, `Community 13`, `Community 17`, `Community 18`, `Community 20`?**
