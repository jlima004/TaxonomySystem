...
<required_reading>
@/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/references/ai-frameworks.md
@/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/jlima/Projetos/TaxonomySystem/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/jlima/Projetos/TaxonomySystem/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/jlima/Projetos/TaxonomySystem/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/jlima/Projetos/TaxonomySystem/.cursor/agents/gsd-eval-planner.md for instructions.
