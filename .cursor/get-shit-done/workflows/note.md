...
- **Global scope**: `/home/jlima/Projetos/TaxonomySystem/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/jlima/Projetos/TaxonomySystem/.cursor/notes/`)
...
2. Glob `/home/jlima/Projetos/TaxonomySystem/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/home/jlima/Projetos/TaxonomySystem/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/jlima/Projetos/TaxonomySystem/.cursor/notes/` — works in any directory
