...
INSTALL_JS_GLOBAL="/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
