...
```bash
INIT=$(node "/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/templates/spec.md.
