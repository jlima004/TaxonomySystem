...
<required_reading>
@/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/references/user-story-template.md
@/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/references/spidr-splitting.md
@/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/references/spidr-splitting.md`. Briefly:
