...
- Usage: Reference from command with `@/home/jlima/Projetos/TaxonomySystem/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/jlima/Projetos/TaxonomySystem/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/jlima/Projetos/TaxonomySystem/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
